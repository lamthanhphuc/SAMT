...
- [report-service/src/main/java/com/example/reportservice/security/SecurityConfig.java](report-service/src/main/java/com/example/reportservice/security/SecurityConfig.java)
...
- [docs/JWT_CLAIM_CONTRACT.md](docs/JWT_CLAIM_CONTRACT.md)
- [ARCH_SECURITY_AUDIT_REPORT.md](ARCH_SECURITY_AUDIT_REPORT.md)
