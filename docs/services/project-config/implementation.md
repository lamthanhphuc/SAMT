...
**Critical Note:** Only idempotent operations (VerifyGroupExists, CheckGroupLeader) are retried. See [grpc-contract.md](grpc-contract.md) for full retry implementation.
...
**For API details, see [api-contract.md](api-contract.md).**
