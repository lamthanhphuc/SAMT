...
1. ❌ **OAuth Login/Link/Unlink** - Doc mentions but NOT implemented
   ...
   - Remove from api-contract.md sections:
...
1. **Standard Response Format** - Doc shows wrapped responses, code returns direct DTOs
   ...
   - Fix: Update api-contract.md response examples
...
- **Gaps:**
  ...
  - Audit log endpoints missing from api-contract.md
...
2. **Group Lifecycle Operations**
   ...
   - Documented in controller but missing from api-contract.md flow diagrams
...
| **gRPC API** | 95% | Well documented in grpc-contract.md |
...
- **Gaps:**
  - Semester API endpoints not in api-contract.md
...
- **api-contract.md:** States "5 seconds"
...
- **api-contract.md:** States "10 seconds timeout"
...
2. **gRPC Ports**
   - Identity: 9091
   - UserGroup: 9095
   - **Doc status:** Documented in grpc-contract.md but not in README.md
...
3. ✅ **Add audit log endpoints** to api-contract.md
4. ✅ **Document gRPC API** in separate grpc-contract.md
...
### High Priority
1. ✅ **Add Semester API endpoints** to api-contract.md
...
4. ✅ **Document audit log endpoints** in Identity Service api-contract.md
5. ✅ **Add Semester API to UserGroup** api-contract.md
...
5. **Semester API** - Implemented but missing from UserGroup api-contract.md
